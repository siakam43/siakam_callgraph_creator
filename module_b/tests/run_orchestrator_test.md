...
- `pre_existing/uid00003.json` — pre-failed result (should be skipped)
...
3. Identify uid00001 (completed) and uid00003 (failed) as skip candidates
4. Add uid00002, uid00004, uid00005, uid00006 to pending list

### Step 3: Verify checkpoint recovery

- [ ] uid00001 is **skipped** (already `status: "completed"`)
- [ ] uid00003 is **skipped** (already `status: "failed"`, no retry)
- [ ] uid00002, uid00004, uid00005, uid00006 appear in the pending list

### Step 4: Verify batch splitting

Check that the 4 pending uids are split into batches:
- Each batch has ≤ 5 uids
- All 4 uids are assigned to at least one batch
...
- [ ] uid00001 and uid00003 retain their original content (not overwritten)
- [ ] uid00002, uid00004, uid00005, uid00006 contain valid Module B output format
...
- Total pending: 4
- Completed: 4 (or fewer if some failed)
- Failed: 0 (or the count if some failed)
